...
/// Deterministic Senior Learning shell for VIS-06 visual capture.
class ScreenshotSeniorLearningPage extends StatelessWidget {
  const ScreenshotSeniorLearningPage({
    super.key,
    this.repository,
