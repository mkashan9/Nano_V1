...
/// Deterministic Senior Home shell for VIS-05 visual capture.
class ScreenshotSeniorHomePage extends StatelessWidget {
  const ScreenshotSeniorHomePage({
    super.key,
    this.repository,
  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          bottom: false,
          child: SeniorHomePage(
            repository: repo,
            learnerName: StudentHomeFixtures.studentName,
            userId: 'screenshot-senior',
            ...
            child: SizedBox(
              ...
              child: Row(
                ...
                children: [
                  ...
                  const _NavItem(icon: Icons.groups_outlined, label: 'Communities'),
                  _NavItem(
