...
import 'package:student_app/features/flex/presentation/student_marks_page.dart';

void main() {
  testWidgets('shows month marks and corrected badge', (tester) async {
    ...
    expect(find.textContaining('Scored 2'), findsOneWidget);
