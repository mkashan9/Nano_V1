...
| Narration and reaction clips through the chosen providers | MED-06 | edge+packages+admin_web | Moderation plays voice and video | generation_providers,narration_voices,reaction_clip_versions | SQL+Deno+widget | USER_TEST |
| Character animation of approved companion art | MED-07 | edge+packages | none yet | generation_providers | SQL+Deno | BACKLOG |
