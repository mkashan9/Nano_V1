...
| Nori voice Aoede; no privileged calc | MED-03,CMP-01 | edge+app | narration lines, Aoede registry, caption-first Listen | narration_voices,narration_lines,narration_line_versions,generated_assets | SQL+unit+widget | USER_TEST |
