...
| Handbook MED-01 Media asset delivery | MED-03,MED-04,MED-05 | edge+admin | providers | generated_assets | quota/hash | BACKLOG |
...
| Generated media cost controls | MED-02 | edge+student_app | budgets, cached delivery, local fallback | generation_quotas,generation_usage,generated_assets | SQL+unit+widget | USER_TEST |
