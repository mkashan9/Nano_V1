...
| Handbook FLX-01 Student Flex | FLX-01,FLX-02,FLX-03,FLX-04 | student_app | Flex | school data | RLS+UI | USER_TEST |
...
| Handbook CLS-01 Classroom | CLS-01,CLS-02,CLS-03 | teacher_app | Classroom | announcements,attachments,acks | ack tests | USER_TEST |
...
| XP rules — video/quiz/games XP; no marks/attendance XP | XP-01..XP-06 | edge | ledger | xp_ledger,level_rules,xp_progress,achievement_definitions,achievement_awards,missions,mission_progress,streaks | idempotency+level+achievements | USER_TEST |
...
| Marks/attendance Excel flows | ATT-02,MRK-03,SCH-03,SCH-04 | teacher+admin | excel | imports | parse tests | USER_TEST |
