...
|----|------|---------|--------|--------------|
| AUD-01 | Repository and Security Audit | R0 | USER_TEST | — |
| FND-01 | Workspace, Configuration, and Environments | R0 | BACKLOG | AUD-01 |
...
| QZ-01 | Superadmin Question Bank | R3 | BACKLOG | SEC-03 |
